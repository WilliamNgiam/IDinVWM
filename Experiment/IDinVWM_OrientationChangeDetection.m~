...
stimulus.nArrayItems = 4;           % Number of items shown in array
...
allChanges = mod(randperm(experiment.nCalibrationTrials),4)+1;              % Randomises which Gabor changes on every changed trial
...
for thisCalibrationTrial = 1:experiment.nCalibrationTrials
    ...
    % Wipe any previous mask textures
...
%     end
    ...
    for thisStaircaseTrial = 1:experiment.nTrialsPerStaircase
        ...
        secondIntervalTime = Screen('Flip', ptbWindow, blankTime + timing.blankDuration);
